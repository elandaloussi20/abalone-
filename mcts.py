...
class Node:
    """ Node dans l'arbre  du jeu. La note gagne est toujours du point de vue de playerJustMoved.
        Se bloque si l'état n'est pas spécifié.
    """
    ...
    def UCTSelectChild(self):
        """ Utilisez la formule UCB1 pour sélectionner le node child. Souvent, une UCTK constante est appliquée, nous avons donc
            lambda c: c.wins / c.visits + UCTK * sqrt (2 * log (self.visits) /c.visits pour faire varier le montant de
    ...
    def AddChild(self, m, s):
        """ supprimez m from untriedMoveset ajoutez un nouveau child node pour ce déplacement .
            Return le  child node ajouté 
        """
